...
print(f"The total of all loans is ${total_all_loans}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = total_all_loans/number_of_loans
...
annual_discount_rate = 0.20
PV = future_value/[1+(annual_discount_rate/12)]**remaining_months
print(f"The present value of the loan is: {round(PV, 2)}")
